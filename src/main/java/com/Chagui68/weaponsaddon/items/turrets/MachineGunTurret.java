...
public class MachineGunTurret extends AbstractTurret {
    public static final SlimefunItemStack MACHINE_GUN_TURRET = new SlimefunItemStack("MA_MACHINE_GUN_TURRET", Material.IRON_BLOCK,
            "&4🔫 &cMachine Gun Turret",
            "",
            "&7A rapid-fire automated defense system.",
            "&7Equipped with 4 rotary mini-guns.",
            "",
            "&6Range: &e10 Blocks", "&6Damage: &e4.0 HP (High fire-rate)",
            "&6Energy: &e20 J per shot",
            "&6Capacity: &e3000 J",
            "",
            "&eRight-Click to place",
            "&eSneak + Right-Click to upgrade", "&8(NBT Structure Model)");
